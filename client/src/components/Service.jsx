...
function Service(){
 ...
 <img src={bikeimage} className="w-[250px] h-[220px] mx-auto lg:w-[525px] lg:h-[466px]"/>
...
<img src={indianmap} className="h-[250px] w-[250px]"/>
<section className="flex items-center gap-[6px]">
<img src={redlocation} className="h-[28px] w-[28px]"/>
