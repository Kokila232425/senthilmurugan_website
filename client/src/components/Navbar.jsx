...
<a href="#home"><img src={logo} alt=""  className="h-[50px] w-[120px] lg:w-[150px] lg:h-[60px]"/></a>
<img src={triplebar} alt="" className="h-[30px] w-[30px] lg:hidden"  onClick={() => setshowModal(true)}/>
<Modal
        isOpen={showModal}
